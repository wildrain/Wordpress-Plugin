...
/*
Plugin Name: adaptive_popular_posts
Plugin URI: http://example.com
Description: a amazing popular posts widget for adaptive framework
...
class Popular_posts extends WP_Widget{
	...
	function widget($args, $instance) {
		...
		$title = !empty($title)? $title: 'Popular_posts';
...
add_action('widgets_init','roman_register_Popular_posts');


function roman_register_Popular_posts(){
